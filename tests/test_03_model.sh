...
ssh_vm "timeout 120 python3 /home/labuser/02_dataset.py" >/dev/null 2>&1 || true

# 3.1 Data preparation (module 04)
log_info "Running 04_prepare.py..."
assert_success "04_prepare.py exits with code 0" \
    ssh_vm "timeout 120 python3 /home/labuser/04_prepare.py"
...
assert_success "05_train.py exits with code 0" \
    ssh_vm "timeout 300 python3 /home/labuser/05_train.py"
...
eval_output=$(ssh_vm "timeout 120 python3 /home/labuser/06_evaluate.py" 2>&1) || true
assert_success "06_evaluate.py exits with code 0" \
    ssh_vm "timeout 120 python3 /home/labuser/06_evaluate.py"
...
assert_success "07_predict.py exits with code 0" \
    ssh_vm "timeout 120 python3 /home/labuser/07_predict.py"

# 3.8 Predictions output contains expected labels
pred_output=$(ssh_vm "timeout 120 python3 /home/labuser/07_predict.py" 2>&1) || true
